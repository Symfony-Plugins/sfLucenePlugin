...
abstract class sfLuceneIndexer
{
  ...
  */
  ...
  {
    $this->getSearch()->getCategoriesHarness()->getCategory($category)->add($c)->getHolder()->save();
  }
  ...
  {
    $this->getSearch()->getCategoriesHarness()->getCategory($category)->subtract($c)->getHolder()->save();
  }
